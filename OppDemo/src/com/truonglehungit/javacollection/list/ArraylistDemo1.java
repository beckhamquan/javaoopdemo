...
public class ArraylistDemo1 {
    ...
    String str = obj.get(0);    // return value at index = 0
    System.out.println(str);
    int numberofitems = obj.size(); // count item of object array (obj)
    boolean check = obj.contains("Steve");
    System.out.println(check);  // return true if exist,false if not exist
